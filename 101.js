...
const C101_PRIMARY_FAMILIES=["Quartz","Calcite","Feldspar","Fluorite","Garnet","Tourmaline","Obsidian","Copper Minerals","Agate","Jasper"];
...
// possible future full "All Families" tier view. Copper Minerals was
// briefly listed here, then moved into the primary grid (2026-07-31,
// replacing Chalcedony) per Christie's approved landing-grid update, so
// this roster is empty again pending a future secondary-family guide.
