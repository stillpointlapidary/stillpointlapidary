# Gate 3 Review — Batch 1 Canonical MDs

**Stones:** Hematite · Moonstone · Sodalite · Malachite · Sunstone

**Status:** All five drafts cleared for Gate 3 review. Sodalite, Malachite, and Sunstone include the approved Book of Stones refinements.

---

# Hematite - Encyclopedia Entry
...
https://vxujlgyhgnihnqrxzefw.supabase.co/storage/v1/object/public/stone-images/encyclopedia/hematite.webp
...
| Category | Detail |
|---|---|
| Energetic Role | Grounding |
| Chakra | Root |
| Element | Earth |
| Planet | Mars |
| Zodiac | Aries · Aquarius |
| Color Energy | Metallic Silver |
...
Chosen when attention has become overly mental and a stronger sense of physical presence would restore perspective.

### Regaining Stability

Used during unsettled periods as a reminder to slow down, establish footing, and respond from a steadier baseline.

### Strengthening Focus

Supports practical concentration when distractions, competing demands, or emotional noise make sustained attention difficult.

### Holding Boundaries

Often carried when firmness and grounded self-possession matter more than argument, intensity, or emotional withdrawal.

### Taking Practical Action

Encourages movement from abstract planning into manageable steps, especially when hesitation has replaced useful momentum.
...
Its strongest tradition centers on bringing awareness back to the body, the present moment, and the concrete conditions that require attention.

#### Stability and Presence

The emphasis here is steady footing rather than rigidity, helping scattered energy settle into a more composed and responsive state.

### Secondary

#### Focus and Practical Clarity

A grounded baseline can make priorities easier to sort, supporting concentration on what is immediate, useful, and realistically achievable.

#### Protection and Boundaries

Its dense, self-contained character is often associated with maintaining personal limits without becoming defensive or emotionally closed.
...
- Western Australia
- Michigan and Minnesota, United States
- Cumbria, England
- Elba, Italy
...
Wipe with a soft dry or slightly damp cloth; use mild soap only when needed and dry promptly.

### Water

Brief contact with water is generally acceptable, but avoid soaking pieces with fractures, porous matrix, or attached labels.

### Light & Heat

Ordinary light is stable; avoid strong heat and rapid temperature changes that may stress fractured or matrix specimens.

### Storage

Store separately from softer stones and keep dry, especially for specimens with mixed iron minerals or unstable matrix.
...
- Slug: smoky-quartz
- Reason: Offers similarly steady grounding with a gentler, more spacious feel and less emphasis on embodiment.

#### Red Jasper

- Slug: red-jasper
- Reason: Shares earthy stability and practical endurance while adding warmth, stamina, and sustained forward movement.
...
- Slug: clear-quartz
- Reason: Adds clarity and amplification to this stone’s dense, stabilizing presence without replacing its grounding function.

#### Black Tourmaline

- Slug: black-tourmaline
- Reason: Combines firm energetic boundaries with the anchoring quality here for environments that feel scattered or intrusive.
...
|---|---|---|
| Crystalpedia | A+ | Grounding, embodiment, stability, focus, protection |
| Crystal Vaults | A | Grounding, courage, Root Chakra, practical steadiness |
| Crystal Council | A | Grounding, focus, balance, protection |
| Moonrise Crystals | A | Embodiment, boundaries, stability, practical use |
| Crystals.com | A | Grounding, focus, confidence, everyday support |
| Crystal Almanac | A | Grounding, Root Chakra, steadiness, courage |

Research minimum: 6 qualified metaphysical sources.

## Complete Geological and Technical Source List

| Source | Type | Key Contributions |
|---|---|---|
| Mindat.org - Hematite | Core mineralogical source | Identity, formula, trigonal system, physical properties, formation, localities |
| Gate 1B approved technical record | Locked cohort research | Treatment status, magnetic simulant warning, normalized technical values |
| Gate 1D approved collector and care record | Locked cohort research | Collector forms, care, market confusion, related stones |

## Theme Decisions

| Theme | Placement | Reason |
|---|---|---|
| Grounding and Embodiment | Primary | Dominant consensus across the approved source set |
| Stability and Presence | Primary | Strong cross-source agreement and distinct from simple protection |
| Focus and Practical Clarity | Secondary | Repeatedly supported as an outcome of grounding |
| Protection and Boundaries | Secondary | Meaningful consensus, but not stronger than grounding |
| Courage | Occasional | Supported, especially through Mars-linked resolve |
| Determination | Occasional | Supported as a situational expression of practical steadiness |

## At a Glance Decisions

- Energetic Role: Grounding
- Primary Chakra: Root
- Secondary Chakra: None
- Element: Earth
- Planet: Mars
- Zodiac: Aries · Aquarius
- Color Energy: Metallic Silver

### Book-Source Confirmation

- Crystalpedia supports the central grounding and embodiment themes.
- Mars and Earth are approved production values.
- Planet and Element remain flagged for Crystal Bible confirmation when available; no public claim currently depends on a disputed correspondence.

## Pairing Decisions

### Similar Energy

- Smoky Quartz: gentler grounding and release
- Red Jasper: grounded endurance and sustained action

### Pairs Well With

- Clear Quartz: clarity and amplification
- Black Tourmaline: protective boundaries and anchoring

## Treatments, Trade Names, Imitations, and Care

- **Treatments:** Natural Hematite is generally untreated.
- **Trade names:** Hematine and magnetic hematite commonly refer to manufactured iron-based products.
- **Imitations and confusion:** Magnetite, molded metallic material, coated objects, and manufactured magnetic beads.
- **Care:** Mild cleaning, limited water exposure, prompt drying, and dry storage.

## Mineral Identity and Relationship Fields

- identity_type: Mineral
- parent_material: Iron oxide
- parent_page_slug: None
- relationship_note: Hematite is a trigonal iron oxide mineral known for metallic luster and a reddish-brown streak
- related_varieties: specularite, kidney-ore, martite
- trade_name_status: Magnetic hematite commonly refers to manufactured material
- man_made_status: Natural material; common manufactured simulant exists
...
Its strongest tradition centers on receptive knowing, helping attention turn inward when an answer cannot be reached through analysis alone.

#### Cyclical Awareness and Change

The lunar emphasis supports recognizing phases, transitions, endings, and beginnings as parts of an unfolding rhythm rather than isolated disruptions.

### Secondary

#### Emotional Balance

Heart and Water associations bring a softer, more responsive quality to periods when emotions shift quickly or feel difficult to interpret.

#### New Beginnings

Rather than pushing for dramatic reinvention, this theme supports entering a new phase with openness, patience, and trust in timing.
...
| Category | Detail |
|---|---|
| Material Type | Feldspar variety |
...
Protect from high heat, thermal shock, and prolonged intense light; feldspar cleavage makes sudden temperature change risky.
...
| Theme | Placement | Reason |
|---|---|---|
| Intuition and Inner Guidance | Primary | Strong Tier A consensus |
| Cyclical Awareness and Change | Primary | Consistent lunar and transition emphasis |
| Emotional Balance | Secondary | Supported across Tier A sources |
| New Beginnings | Secondary | Repeated but subordinate to intuition and cycles |
| Dreams | Occasional | Common and situational |
| Feminine Wisdom | Occasional | Traditional association, but not universal or identity-defining |
...
- Crystalpedia does not contain a Moonstone entry.
- Tier A sources independently support all current primary and secondary theme placements.
- Tier B sources reinforce dreams and new-beginning language but do not establish any unique primary claim.
- Crystal Bible verification is still required when available.
- No current public claim is expected to change materially unless the book source presents a substantially different theme hierarchy.

## Pairing Decisions

### Similar Energy

- Labradorite: intuitive feldspar with transformation and protection emphasis
- Rainbow Moonstone: brighter feldspar counterpart with similar transitional associations

### Pairs Well With

- Rose Quartz: compassion and relational warmth
- Sunstone: outward vitality and confidence

## Treatments, Trade Names, Imitations, and Care

- **Treatments:** Usually untreated; fracture filling has been documented.
- **Trade names:** Rainbow Moonstone commonly refers to white Labradorite.
- **Imitations and confusion:** Glass, assembled material, white Labradorite, and other feldspars.
- **Care:** Warm soapy water, no ultrasonic or steam, avoid thermal shock.

## Mineral Identity and Relationship Fields

- identity_type: Feldspar variety
- parent_material: Feldspar group
- parent_page_slug: None
- relationship_note: Moonstone is defined by adularescence and may occur in more than one feldspar host
- related_varieties: rainbow-moonstone, peach-moonstone, gray-moonstone
- trade_name_status: Rainbow Moonstone is commonly white Labradorite
- man_made_status: Natural material; assembled and glass imitations occur
...
https://vxujlgyhgnihnqrxzefw.supabase.co/storage/v1/object/public/stone-images/encyclopedia/sodalite.webp
...
Its strongest tradition centers on bringing analysis, intuition, observation, and creativity together so scattered information can become a coherent understanding.

#### Logical-Intuitive Insight

Rather than treating reason and intuition as opposites, this theme supports their deliberate integration, allowing each to test, refine, and deepen the other.

### Secondary

#### Truthful Communication

The Throat emphasis carries inward understanding into clear expression, especially when honesty, precision, and thoughtful language all matter.

#### Self-Understanding

Its reflective quality supports a more dispassionate view of personal motives, strengths, habits, and contradictions without immediately defending or distorting them.
...
Keep away from prolonged intense sunlight when tenebrescent Hackmanite is involved; avoid high heat and sudden temperature changes.
...
| Source | Tier | Key Contributions |
|---|---|---|
| Crystalpedia | A+ | Clarity, logic, truth, communication, intuition |
| Crystal Vaults | A | Throat and Third Eye, truth, focus, communication |
| Crystal Council | A | Logic, communication, self-understanding |
| Moonrise Crystals | A | Intellectual order, authenticity, group harmony |
| Crystals.com | A | Clarity, communication, truth |
| Crystal Almanac | A | Focus, reason, expression, Sagittarius |
...
| Source | Type | Key Contributions |
|---|---|---|
| Mindat.org - Sodalite | Core mineralogical source | Species identity, formula, crystal system, formation, localities |
| Gate 1B approved technical record | Locked cohort research | Treatment status, physical properties, imitation risks |
| Gate 1D approved collector and care record | Locked cohort research | Collector context, care, related stones |

## Theme Decisions

| Theme | Placement | Reason |
|---|---|---|
| Mental Clarity and Integration | Primary | Dominant consensus and the clearest expression of the locked role |
| Truthful Communication | Primary | Strong Throat-centered agreement across sources |
| Logic and Intuition | Secondary | Meaningful cross-source consensus |
| Self-Acceptance | Secondary | Supported as an outcome of truthful self-understanding |
| Group Harmony | Occasional | Supported but situational |

## Differentiation Brief

- Sodalite expresses Clarity & Focus through logical integration, truth, and communication.
- Rainbow Fluorite expresses the same role through mental organization, concentration, and sorting complexity.
- Lapis Lazuli expresses it through wisdom, truth, and articulate insight.
- Public copy has been audited to avoid making the three stones interchangeable.
...
- Lapis Lazuli: wisdom and articulate truth
- Blue Lace Agate: gentler communication and calm

### Pairs Well With

- Clear Quartz: focus and amplification
- Carnelian: courage and outward action

## Treatments, Trade Names, Imitations, and Care

- **Treatments:** Natural material is generally untreated; dyeing is possible but prevalence remains uncertain.
- **Imitations and confusion:** Lapis Lazuli, dyed Howlite, Magnesite, Calcite, and other blue materials.
- **Care:** Mild soap, no ultrasonic or steam, avoid soaking and strong heat.

## Mineral Identity and Relationship Fields

- identity_type: Mineral
- parent_material: Sodalite group
- parent_page_slug: None
- relationship_note: Sodalite is a blue feldspathoid mineral commonly patterned with white Calcite
- related_varieties: hackmanite
- trade_name_status: Princess Sodalite is a locality-linked market name for Ontario material
- man_made_status: Natural material; dyed and imitation blue stones occur
...
https://vxujlgyhgnihnqrxzefw.supabase.co/storage/v1/object/public/stone-images/encyclopedia/malachite.webp
...
- Slug: mahogany-obsidian

#### Next Stone

- Name: Mangano Calcite
- Slug: mangano-calcite
...
| Category | Detail |
|---|---|
| Energetic Role | Transformation |
| Chakra | Heart |
| Secondary Chakra | Solar Plexus |
| Element | Fire |
| Planet | Venus |
| Zodiac | Scorpio · Capricorn |
| Color Energy | Vivid Green |
...
Chosen when a familiar habit or emotional response keeps repeating even after its cost has become clear.

### Facing Necessary Change

Used when transformation can no longer be postponed and the next step requires honesty rather than reassurance.

### Choosing Courage

Supports the resolve to act on what has already been recognized, especially when discomfort tempts a return to old behavior.

### Releasing Emotional Baggage

Encourages examination of attachments, grievances, and defenses that consume energy without protecting what truly matters.

### Growing Through Discomfort

Often selected when meaningful development requires staying present with challenge rather than escaping, minimizing, or controlling it.
...
#### Transformation Through Right Action

Its strongest tradition centers on turning insight into responsible action, especially when growth requires a clear choice rather than further delay or emotional avoidance.

#### Courage and Personal Responsibility

This theme supports the willingness to acknowledge one’s role, make a conscious decision, and follow through with integrity even when the path is uncomfortable.

### Secondary

#### Conscious Leadership

Solar Plexus associations emphasize conviction, self-discipline, and the ability to influence circumstances through responsible, values-based leadership.

#### Heart-Centered Discernment

Heart Chakra traditions connect transformation with emotional clarity, helping compassion and honesty guide decisions without weakening necessary boundaries.
...
Use a soft damp cloth and mild soap sparingly; never use acids, ammonia, ultrasonic cleaners, steam, or abrasive compounds.

### Water

Avoid soaking. Malachite is soft, copper-bearing, and may be porous, stabilized, dyed, or coated.

### Light & Heat

Protect from heat, direct prolonged sunlight, solvents, and rapid temperature changes that can damage treatments or polish.

### Storage

Store separately in a padded compartment; avoid scratches, impacts, and contact with harder stones or acidic materials.
...
- Slug: moldavite
- Reason: Shares an uncompromising transformation theme, with a faster and more catalytic spiritual emphasis.

#### Labradorite

- Slug: labradorite
- Reason: Supports change and self-discovery with a more protective, intuitive, and gradually unfolding character.
...
- Slug: rose-quartz
- Reason: Adds compassion and emotional gentleness to the direct pattern-breaking and growth work here.

#### Black Tourmaline

- Slug: black-tourmaline
- Reason: Provides firm grounding and boundaries when transformative work feels intense or exposing.
...
| Source | Tier | Key Contributions |
|---|---|---|
| Crystalpedia | A+ | Transformation, courage, pattern breaking, protection |
| Crystal Vaults | A | Change, Heart Chakra, protection, abundance |
| Crystal Council | A | Transformation, emotional growth, courage |
| Moonrise Crystals | A | Pattern recognition, growth, emotional truth |
| Crystals.com | A | Change, courage, protection |
| Healing Crystals | B | Heart-centered growth, emotional release |
...
| Source | Type | Key Contributions |
|---|---|---|
| Mindat.org - Malachite | Core mineralogical source | Identity, formula, crystal system, formation, physical properties |
| GIA - Ultrasonic Cleaner Guidance | Core gemological source | Unsuitability for ultrasonic cleaning |
| Gate 1B approved technical record | Locked cohort research | Stabilization, imitation risk, localities |
| Gate 1D approved collector and care record | Locked cohort research | Restrictive care, collector context, related stones |

## Theme Decisions

| Theme | Placement | Reason |
|---|---|---|
| Transformation and Pattern Breaking | Primary | Dominant consensus across the approved source set |
| Courageous Change | Primary | Strongly supported and distinct from passive release |
| Heart-Centered Growth | Secondary | Supported by Heart Chakra consensus |
| Protection and Discernment | Secondary | Repeated, but subordinate to transformation |
| Abundance | Occasional | Present in tradition but not identity-defining |
...
- Crystalpedia supports the central transformation and courage themes.
- Fire is the approved production value and is consistent across the current Tier A synthesis.
- Element remains flagged for Crystal Bible confirmation because Fire is less visually intuitive than Earth or Water, but no public claim depends on the correspondence being explained.

## Pairing Decisions

### Similar Energy

- Moldavite: catalytic transformation
- Labradorite: gradual intuitive change

### Pairs Well With

- Rose Quartz: compassion and emotional gentleness
- Black Tourmaline: grounding and boundaries

## Treatments, Trade Names, Imitations, and Care

- **Treatments:** Wax, oil, resin, or polymer impregnation may be used.
- **Imitations and confusion:** Reconstructed powder, molded resin, dyed substitutes, and printed or mechanically striped imitations.
- **Care:** No acids, ammonia, ultrasonic cleaning, steam, soaking, abrasives, or high heat.

## Mineral Identity and Relationship Fields

- identity_type: Mineral
- parent_material: Copper carbonate
- parent_page_slug: None
- relationship_note: Malachite is a secondary copper mineral known for green fibrous and banded growth
- related_varieties: None
- trade_name_status: None
- man_made_status: Natural material; reconstructed and imitation products are common
...
https://vxujlgyhgnihnqrxzefw.supabase.co/storage/v1/object/public/stone-images/encyclopedia/sunstone.webp
...
| Category | Detail |
|---|---|
| Energetic Role | Vitality |
| Chakra | Sacral |
| Secondary Chakra | Solar Plexus |
| Element | Fire |
| Planet | Sun |
| Zodiac | Leo · Libra |
| Color Energy | Iridescent |
...
Chosen when energy has become flat and renewed interest, warmth, or creative participation would restore momentum.

### Building Confidence

Supports a stronger willingness to be visible, express preferences, and act without excessive dependence on approval.

### Acting Independently

Encourages self-directed decisions when hesitation or other people’s expectations have begun to dominate the process.

### Leading Boldly

Often selected when responsibility requires warmth, clarity, initiative, and the courage to occupy a more visible role.

### Choosing Joy

Invites deliberate engagement with pleasure, creativity, and possibility rather than treating joy as something that must arrive unbidden.
...
Its strongest tradition centers on renewed life force, enthusiasm, and the willingness to participate fully rather than remain on the sidelines.

#### Confidence and Independence

The emphasis here is self-directed action, helping personal authority grow without becoming rigid, performative, or dependent on applause.

### Secondary

#### Joy and Creative Warmth

Sacral associations support pleasure, creative expression, sociability, and a brighter emotional relationship with action.

#### Leadership and Initiative

Solar energy strengthens visible, benevolent leadership, supporting initiative, conviction, and the responsibility to use personal influence with warmth, generosity, and purpose.
...
|---|---|
| Material Type | Feldspar variety |
| Typical Composition | Feldspar with reflective mineral or native Copper inclusions |
| Common Feldspar Hosts | Oligoclase, Labradorite, Orthoclase, Microcline, or Albite |
| Crystal Structure | Triclinic or monoclinic, depending on host |
| Mohs Hardness | 6 to 6.5 |
| Cleavage | Perfect to good in two directions |
| Luster | Vitreous |
| Optical Effect | Aventurescence |
...
### Do Not Confuse It with Goldstone
...
Clean with warm water, mild soap, and a soft cloth or brush; avoid ultrasonic and steam cleaners.

### Water

Brief washing is suitable, but avoid soaking fracture-filled stones or pieces with uncertain treatment history.

### Light & Heat

Avoid high heat, thermal shock, and prolonged intense light, especially in unusually saturated or potentially treated material.

### Storage

Store in a padded compartment away from harder gems; feldspar cleavage makes sharp impacts a greater concern than hardness suggests.
...
- Slug: carnelian
- Reason: Shares vitality, confidence, and creative drive with a steadier, more grounded emphasis on action.

#### Citrine

- Slug: citrine
- Reason: Offers similarly bright confidence and momentum while leaning more strongly toward abundance and manifestation.
...
- Slug: moonstone
- Reason: Balances outward confidence with receptivity, intuition, cycles, and inward listening.

#### Black Tourmaline

- Slug: black-tourmaline
- Reason: Adds grounding and protective structure so enthusiasm can become sustained, practical action.
...
| Source | Tier | Key Contributions |
|---|---|---|
| Crystalpedia | A+ | Vitality, confidence, joy, independence, leadership |
| Crystal Vaults | A | Sun, Fire, vitality, leadership, good fortune |
| Crystal Council | A | Confidence, action, independence, joy |
| Moonrise Crystals | A | Self-direction, optimism, creative engagement |
| Crystals.com | A | Vitality, confidence, abundance |
| Energy Muse | B | Joy, leadership, motivation |
...
| Source | Type | Key Contributions |
|---|---|---|
| Mindat.org - Sunstone | Core mineralogical source | Feldspar-variety identity, host variability, aventurescence |
| GIA - Sunstone | Core gemological source | Oregon material, Copper inclusions, color and market context |
| GIA - Sunstone Care and Cleaning | Core gemological source | Cleaning and heat precautions |
| Gate 1B approved technical record | Locked cohort research | Treatments, imitations, localities, adapted labels |

## Theme Decisions

| Theme | Placement | Reason |
|---|---|---|
| Vitality and Engagement | Primary | Dominant consensus and locked energetic role |
| Confidence and Independence | Primary | Strong cross-source agreement |
| Joy and Creative Warmth | Secondary | Repeated Sacral-centered association |
| Leadership and Initiative | Secondary | Supported through Solar and Fire traditions |
| Good Fortune | Occasional | Common but not identity-defining |
...
- Carnelian: grounded vitality and creative action
- Citrine: confidence, abundance, and manifestation

### Pairs Well With

- Moonstone: receptivity and cyclical awareness
- Black Tourmaline: grounding and protective structure

## Treatments, Trade Names, Imitations, and Care

- **Treatments:** Copper diffusion, irradiation-related color modification, and fracture filling have been documented in feldspar material.
- **Trade names:** Sunstone spans multiple feldspar hosts; Oregon Sunstone commonly refers to copper-bearing Labradorite.
- **Imitations and confusion:** Goldstone and other aventurine glass.
- **Care:** Warm soapy water, no ultrasonic or steam, avoid high heat and thermal shock.
...
- parent_material: Feldspar group
- parent_page_slug: None
- relationship_note: Sunstone is a trade and variety name spanning several feldspar hosts with aventurescent inclusions
- related_varieties: oregon-sunstone
- trade_name_status: Sunstone does not identify one universal feldspar species
- man_made_status: Natural material; Goldstone is a manufactured glass imitation
