...
Energetic Themes · Collector & Curiosity Notes · Care & Cleaning
...
**Care & Cleaning is a direct child of `.content-stack-right`**, positioned below Collector & Curiosity Notes. It is not a full-width section and does not appear outside the right stack.
...
| Care & Cleaning | `care-cleansing` — SVG: `https://vxujlgyhgnihnqrxzefw.supabase.co/storage/v1/object/public/stone-images/icons/encyclopedia/care-cleansing.svg` |
...
| 2026-06-28 | Market & Buying Notes is a standalone right-rail card, not part of Mineral Profile. Sourced from `collector_context_p3`. Rendered only if non-null. Right-rail section order locked: Energetic Themes · Collector & Curiosity Notes · Market & Buying Notes · Care & Cleaning. Mobile order updated accordingly. | §1.1, §7, §8 | Christie |
...
| 2026-06-28 | Care & Cleaning renders as stacked icon rows (26px icon + label + body), not a 2×2 grid. No wash background on outer container. `.care-cell` uses `grid-template-columns: 26px 1fr`. | §8a | Christie |
...
| 2026-06-28 | Public section name renamed from "Care & Cleansing" to "Care & Cleaning." Rationale: the section contains physical care information only; "Cleansing" implies energetic ritual. Database table (`enc_care`) and internal category labels (Cleaning, Water, Light & Heat, Storage) are unchanged. Section ID `#care` is unchanged. | §8a | Christie |
